...
import modem.{FIRCoefficientChangeCommand, Modem, ModemAnalogIO, ModemIFCounterStateIO, ModemADCClockTuningStateIO, ModemLUTCommand, ModemTuningControl, ModemTuningRXEnable}
import ee290cdma._
...
class BMC(params: BasebandModemParams, beatBytes: Int) extends Module {
  ...
  modem.io.lo_div8_clock := io.lo_div8_clock
  ...
  modem.io.adcClockTuning <> io.adcClockTuning
  modem.io.lo_counter := io.lo_counter
